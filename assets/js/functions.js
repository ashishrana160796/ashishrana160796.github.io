...
function interestStuff() {
  ...
  $('.interest-logo, .interest-button').click(function() {
    var $this = $(this),
        position = $this.parent().children().index($this);

    $('.interest-unit').removeClass('active-interest').eq(position).addClass('active-interest');
    $('.interest-logo').removeClass('active-interest').eq(position).addClass('active-interest');
    $('.interest-button').removeClass('active-interest').eq(position).addClass('active-interest');
  });


  $('.interest-control-next, .interest-control-prev').click(function() {
    ...
    var $this = $(this),
      ...
      if($this.hasClass('interest-control-next')) {
        ...
        if(position < interestNum -1){
          ...
          $('.interest-button').removeClass('active-interest').first().addClass('active-interest');
        }
        ...
        if (position === 0) {
          ...
          $('.interest-button').removeClass('active-interest').last().addClass('active-interest');
        } else {
...
(function ($) {
	...
	$.fn.autosize = function (options) {
		...
		return this.each(function () {
			...
			// The mirror width must exactly match the textarea width, so using getBoundingInterestRect because it doesn't round the sub-pixel value.
			// window.getComputedStyle, getBoundingInterestRect returning a width are unsupported, but also unneeded in IE8 and lower.
			function setWidth() {
				var width;
				...
				if (style) {
					...
					width = ta.getBoundingInterestRect().width;
